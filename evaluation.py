...
def evaluation(label,predict,thres=0.5):
    ...
    # print('valid_pre_distribution:',np.sum(predict,axis=0))
    # print('valid_groundtruth_distribution:', np.sum(label, axis=0))
...
def print_result(loss,label,predict,datatype,thres=0.5*np.ones(5)):
    ...
    # print(datatype + '_F1score_b_perclass: ' + str(performance_table['F1score_b_class']))
    ...
    # print(datatype + '_MAPvalue_perclass: ' + str(performance_table['map_class']))
